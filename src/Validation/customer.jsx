...
export const customerValidation = Yup.object().shape({
  ...
  OwnerAddress2: Yup.string().optional(),
  ...
  ReferralSourceName: Yup.string()
    .required('Referral Source Name is required'),
  ...
  InsuranceAgentName: Yup.string()
    .required('Insurance Agent Name is required'),

  EstimatorName: Yup.string()
    .required('Estimator Name is required'),
