...
const Customer = () => {
  ...
  const {handleShow, ModalComponent} = useDeleteModal();
...
>
                        ...
                        <td>
                          ...
                          <button className="btn btn-sm btn-outline-danger p-1" onClick={()=>handleShow(value?.id)}><i className="bi bi-trash3"></i></button>
                        </td>
                      </tr>
                    }
