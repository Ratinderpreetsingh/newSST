  ...
  return (
    <>
      ...
      <div className="content-container">
        <h1><i className="bi bi-speedometer2"></i>Shops Customer</h1>
                        ...
                        : shopList && shopList?.data?.map((shop, index) => {
                          ...
                          return <tr key={shop.id}>
                            ...
                            <td>
                              ...
                              <button className="btn btn-sm btn-outline-danger p-1" onClick={() => handleShow(shop)}><i className="bi bi-trash3"></i></button>
